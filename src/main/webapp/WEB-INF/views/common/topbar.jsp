                    ...
                    <div class="container" style="width: 100%;padding: 0;">
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#" class="dropdown-toggle " data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Fund Transfer<span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li class=" dropdown">
                                            <a href="../account/beneficiaryAdd">Add Beneficiary</a>
                                        </li>
                                        <li><a href="../account/transferFunds">Transfer Funds</a></li>
                                    </ul></li>
