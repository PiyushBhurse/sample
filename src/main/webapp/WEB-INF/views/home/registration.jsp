...
<body>
							...
							<form:form cssClass="form-horizontal"
								...
								<div class="panel panel-default">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="req col-md-3 control-label">Date of
													Birth</label>
												<div class="col-md-8 col-xs-12">
								...
								<div class="panel panel-default">
									...
									<div class="row">
										<div class="col-md-6">
											<h5 class="panel-title" style="margin-left: 3%">
												<li>DOB Proof</li>
											</h5>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="req col-md-3 control-label">Document
													Desc</label>
												<div class="col-md-8 col-xs-12">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$.validator.addMethod("checkIFileExtension", function() {
