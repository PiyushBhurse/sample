											...
											<tbody>
												...
												<tr>
													...
													<td><fmt:formatDate pattern="dd-MM-yyyy hh:mm"
															value="${savingAccount.accountCreatedDate}" /></td>
													<td><fmt:formatDate pattern="dd-MM-yyyy hh:mm"
															value="${savingAccount.accountUpdatedDate}" /></td>
												</tr>
												<%--</c:forEach>--%>
											</tbody>
										</table>
											...
											<tbody>
												<c:forEach items="${termAccount}" var="ta">
													<tr>
														...
														<td><fmt:formatDate pattern="dd-MM-yyyy hh:mm"
																value="${ta.accountCreatedDate}" /></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
								...
								<div class="row">
									<div class="col-md-12">
										<form:form cssClass="form-horizontal"
											...
											method="post" modelAttribute="account" name="form1"
											id="form1">
											<!--Customer details-->
