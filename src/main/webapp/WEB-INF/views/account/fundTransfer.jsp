						...
						<div class="panel panel-default"
							...
							<div class="panel-body">
								...
								<form:form cssClass="form-horizontal"
									action="../account/fundTransfer?${_csrf.parameterName}=${_csrf.token}"
									method="post" modelAttribute="fundTransaction" name="formx"
									id="formx">
									<div class="row">
										<div class="col-md-12">
												...
												<div class="col-md-11">
													<div class="form-group">
														...
														<div class="col-md-7 col-xs-12">
															<form:select path="beneficiaries"
																cssClass="form-control select">
																<c:forEach items="${beneficiaryList}" var="benificiary">
																	<option value="${benificiary.benId}">${benificiary.benNickName}&nbsp;(${benificiary.benAccNum}
																		- ${benificiary.benName})</option>
																</c:forEach>
															</form:select>
											...
											<div class="row" style="margin-top: 1%; margin-left: 15%">
												<div class="col-md-11">
													<div class="form-group">
														...
														<div class="col-md-7 col-xs-12">
															<form:input path="tranDesc" maxlength="100"
																cssClass="form-control" />
															<span class="help-block">Please enter notes for
																transaction</span>
														</div>
													</div>
												</div>
											...
											<div class="row" style="margin-top: 1%; margin-left: 15%">
												<div class="col-md-11">
													<div class="form-group">
														<label class="req col-md-2 control-label">Transaction
															Amount</label>
														<div class="col-md-7 col-xs-12">
															<form:input path="tranAmt" maxlength="100"
																cssClass="form-control" />
															<span id="depAmtMsg" style="color: red; display: none;"></span>
															<span class="help-block">Please enter transaction
																amount</span>
														</div>
													</div>
												</div>
														...
														<div class="form-group">
															...
															<div class="col-md-7 col-xs-12">
																<form:input path="intRate" readonly="true"
																	cssClass="form-control" />
																<span class="help-block">Interest rate calculated
																	based on your deposite tenure and amt</span>
															</div>
														</div>
													</div>
